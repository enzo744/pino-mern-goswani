...
const Comments = () => {
  ...
  const { data, loading, error } = useFetch(`${getEnv
    ("VITE_API_BASE_URL")}/comment/get-all-comment`, {
    method: "get",
    credentials: "include",
  }, [refreshData])
          ...
          <Table>
            ...
            <TableBody>
              {data && data.comments.length > 0 ? (
                data.comments.map((comment) => 
                    <TableRow key={comment._id}>
                        ...
                        <TableCell className="flex gap-3">
                            ...
                            <Button onClick={() => handleDelete(comment._id)} variant="outline" 
                ...
                <TableRow>
                  <TableCell colSpan="3">Nessun Commento presente</TableCell>
                </TableRow>
              )}
            </TableBody>
          </Table>
